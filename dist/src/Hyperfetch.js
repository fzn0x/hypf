...
(function (factory) {
    ...
    const DEFAULT_MAX_TIMEOUT = 2147483647; // 10 seconds
    ...
    function createRequest(baseUrl, hooks, DEBUG = false) {
        ...
        const request = (url = '', options = {}, data) => __awaiter(this, void 0, void 0, function* () {
            var _a;
            try {
        ...
        const httpMethodFunction = (url, options) => (method = 'GET', additionalOptions = {}, data) => __awaiter(this, void 0, void 0, function* () {
        ...
        return {
            ...
            patch: httpMethodFunction(),
            options: httpMethodFunction(),
            getAbortController,
        };
    }
