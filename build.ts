/*
  This script is heavily inspired by `built.ts` used in @kaze-style/react and hono.
  https://github.com/taishinaritomi/kaze-style/blob/main/scripts/build.ts and https://github.com/honojs/hono/blob/main/build.ts
  MIT License
